  ...
  Widget _buildFormattedReading() {
    ...
    return Html(
      ...
      style: {
          ...
          "p": Style(
            color: AurennaTheme.textPrimary,  // Changed from silverMist for better contrast
          ...
          "div.real-talk p": Style(
            ...
            fontStyle: FontStyle.italic,
            color: AurennaTheme.textPrimary,  // Ensure good contrast
          ),
          "strong": Style(
            color: AurennaTheme.electricViolet,  // Changed to electric violet for better visibility
            fontWeight: FontWeight.bold,
          ),
          "div.homework": Style(
            margin: Margins.only(bottom: 20),
            padding: HtmlPaddings.all(20),
            backgroundColor: AurennaTheme.mysticBlue.withValues(alpha: 0.2),  // Lighter background
          ),
          "h4": Style(
            color: AurennaTheme.electricViolet,  // Changed from mysticBlue for better contrast
            fontSize: FontSize(16),
            fontWeight: FontWeight.bold,
            margin: Margins.only(bottom: 12),
          ),
          ...
          "li": Style(
            color: AurennaTheme.textPrimary,  // Changed from silverMist for better readability
            fontSize: FontSize(15),
          ...
          "div.final-push p": Style(
            margin: Margins.only(bottom: 12),
            color: AurennaTheme.textPrimary,  // Ensure readability
          ),
          "em": Style(
            fontStyle: FontStyle.italic,
            color: AurennaTheme.electricViolet,  // Changed for better contrast
          ),
          "p.signature": Style(
            fontSize: FontSize(16),
            fontWeight: FontWeight.bold,
